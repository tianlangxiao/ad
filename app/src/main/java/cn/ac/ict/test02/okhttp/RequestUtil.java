package cn.ac.ict.test02.okhttp;
...
class RequestUtil {
    ...
    RequestUtil(String methodType, String url, String jsonStr, Map<String, String> paramsMap, CallBackUtil callBack) {
        this(methodType,url,jsonStr,null,null,null,null,null,paramsMap,null,callBack);
    }
